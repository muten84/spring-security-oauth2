...
/**
 * The persistent class for the REPARTI_DA_IMPORTARE database table.
 * 
 */
@Entity
@Table(name="REPARTI_DA_IMPORTARE")
public class RepartiDaImportareDO implements Serializable {
