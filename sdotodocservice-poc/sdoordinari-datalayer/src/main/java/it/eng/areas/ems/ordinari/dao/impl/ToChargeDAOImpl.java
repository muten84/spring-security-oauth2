...
import it.eng.areas.ems.ordinari.dao.ToChargeDAO;
import it.eng.areas.ems.ordinari.entity.DdtDO;
import it.eng.areas.ems.ordinari.entity.ToChargeDO;
...
@Repository
public class ToChargeDAOImpl extends EntityDAOImpl<ToChargeDO,String> implements ToChargeDAO {

	public Class<ToChargeDO> getEntityClass() {
