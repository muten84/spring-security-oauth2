...
/**
 * The persistent class for the TO_CICLICAL_BOOKING_PATIENT database table.
 * 
 */
@Entity
@Table(name="TO_CICLICAL_BOOKING_PATIENT")
public class ToCiclicalBookingPatientDO implements Serializable {
	...
	public ToCiclicalBookingPatientDO() {
	}
