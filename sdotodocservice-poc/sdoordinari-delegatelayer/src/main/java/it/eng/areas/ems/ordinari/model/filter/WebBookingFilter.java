package it.eng.areas.ems.ordinari.model.filter;
...
public class WebBookingFilter extends EntityFilter implements Serializable  {
	...
	public String getNosological() {
		return nosological;
	}
	public void setNosological(String nosological) {
		this.nosological = nosological;
	}
