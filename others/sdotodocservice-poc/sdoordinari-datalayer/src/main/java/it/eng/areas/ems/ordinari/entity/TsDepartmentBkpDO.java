...
/**
 * The persistent class for the TS_DEPARTMENT_BKP database table.
 * 
 */
@Entity
@Table(name="TS_DEPARTMENT_BKP")
public class TsDepartmentBkpDO implements Serializable {
