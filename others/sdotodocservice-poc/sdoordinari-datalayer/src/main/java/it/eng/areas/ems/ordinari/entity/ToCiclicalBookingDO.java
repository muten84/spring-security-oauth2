...
/**
 * The persistent class for the TO_CICLICAL_BOOKING database table.
 * 
 */
@Entity
@Table(name="TO_CICLICAL_BOOKING")
public class ToCiclicalBookingDO implements Serializable {
