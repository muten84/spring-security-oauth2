...
import it.eng.areas.ems.ordinari.dao.ToBookingPatientDAO;
...
@Repository
public class ToBookingPatientDAOImpl extends EntityDAOImpl<ToBookingPatientDO,String> implements ToBookingPatientDAO {

	public Class<ToBookingPatientDO> getEntityClass() {
