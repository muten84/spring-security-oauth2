...
public class MonitorInfoDemo {
	...
	private static void enumeratePhysicalMonitor(HANDLE hPhysicalMonitor) {
		...
		System.out.println("CAPS "
				+ EnumUtils.setFromInteger(caps.getValue().intValue(), HighLevelMonitorConfigurationAPI.MC_CAPS.class));
		...
		Dxva2.INSTANCE.SetMonitorBrightness(hPhysicalMonitor, 40);
		...
		Dxva2.INSTANCE.SetMonitorContrast(hPhysicalMonitor, 100);
		...
		Dxva2.INSTANCE.GetMonitorDisplayAreaSize(hPhysicalMonitor, ptSizeType, pdwMinimumSize, pdwCurrentSize,
				pdwMaximumSize);
		...
		Dxva2.INSTANCE.GetMonitorRedGreenOrBlueGain(hPhysicalMonitor, ptGainType, pdwMinimumGain, pdwCurrentGain,
				pdwMaximumGain);
		...
		Dxva2.INSTANCE.GetMonitorRedGreenOrBlueDrive(hPhysicalMonitor, ptDriveType, pdwMinimumDrive, pdwCurrentDrive,
				pdwMaximumDrive);
