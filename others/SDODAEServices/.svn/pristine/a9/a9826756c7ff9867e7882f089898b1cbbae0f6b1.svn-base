...
public class DaeDeepDepthRule implements FetchRule {
	...
	public void applyRule(Criteria criteria) {
		...
		criteria.setFetchMode("responsabile.comuneResidenza", FetchMode.JOIN);
		criteria.setFetchMode("responsabile.comuneResidenza.provincia", FetchMode.JOIN);
		...
		criteria.setFetchMode("programmiManutenzione.responsabile", FetchMode.JOIN);
		criteria.setFetchMode("programmiManutenzione.responsabile.comune", FetchMode.JOIN);
		criteria.setFetchMode("programmiManutenzione.responsabile.comune.provincia", FetchMode.JOIN);
