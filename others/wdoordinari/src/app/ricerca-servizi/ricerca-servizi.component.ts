import {
    ViewChild, ElementRef, Directive, Component,
    OnInit, AfterContentChecked, AfterViewInit, ViewEncapsulation,
...
import { RicercaServiziFilter, ServiceSearchItem } from './ricerca-servizi-model';
...
@Component({
    selector: 'ricerca-servizi',
    templateUrl: './ricerca-servizi.component.html',
    encapsulation: ViewEncapsulation.None,
    providers: [PaginationConfig],
})
export class RicercaServiziComponent implements OnInit, MiddleComponent, AfterContentChecked, AfterViewInit {
    ...
    public onOptionItemClicked(data: any): any {
        ...
        this.router.navigate(['/modifica-prenotazione', data.row.id]);
    }
