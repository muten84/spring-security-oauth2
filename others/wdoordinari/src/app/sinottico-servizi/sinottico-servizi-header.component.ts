...
import { FiltroSinottico, TransportModuleServiceService } from 'services/gen';
...
export class SinotticoServiziHeaderComponent implements OnInit, HeaderComponent, AfterViewInit {
    ...
    public listAddFilterItems: ItemFiltroServizi[] = [];
    ...
    constructor(private componentService: ComponentHolderService, private transportService: TransportModuleServiceService) {
    ...
    resetFilter(): void {
        ...
        this.filtroCodaServizi = {
            ...
            interH: undefined,
            fuoriBO: undefined,
            transportDate: null,//transportDateToSet,
            listaElementiFiltro: [],
