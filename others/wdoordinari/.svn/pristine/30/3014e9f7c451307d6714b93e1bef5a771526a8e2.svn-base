...
import { PatientArchiveModuleServiceService } from 'services/gen';
import { GenericResultDTO, PatientArchiveDTO, PatientFilterDTO } from 'services/services.module';
...
export class RicercaPazienteModalComponent implements OnInit {
    ...
    public model: PatientArchiveDTO & {
        birthDateObj?: any;
    };

    private confirmDialogOptions: NgbModalOptions = { windowClass: 'ricerca-paziente-confirm-modal' };

    ARCHIVIO_UTENTI_TRASPORTATI: boolean;

    showPatientRegistryList: boolean = false;

    columnsPatientRegistryTable: Array<CoreTableColumn> = [
    ...
    columnsPatientArchiveTable: Array<CoreTableColumn> = [
    ...
    patientList: Array<PatientArchiveDTO> = [];

    constructor(private activeModal: NgbActiveModal, private archiveService: PatientArchiveModuleServiceService,
