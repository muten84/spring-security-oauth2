...
export class RicercaAvanzataPrenotazioniTableComponent implements OnInit, MiddleComponent, OnDestroy, AfterViewInit, AfterContentChecked {
    ...
    constructor(private componentService: ComponentHolderService, private bookingService: BookingModuleServiceService, paginationConfig: PaginationConfig, private router: Router) {
